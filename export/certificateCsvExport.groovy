records.each { Certificate c ->
	csv << [
			...
			"printed"                        : c.printedOn?.format("yyyy-MM-dd'T'HH:mm:ssXXX"),
			...
			"studentCreatedOn"               : c.student.contact.createdOn?.format("yyyy-MM-dd'T'HH:mm:ssXXX"),
			"studentModifiedOn"              : c.student.contact.modifiedOn?.format("yyyy-MM-dd'T'HH:mm:ssXXX"),

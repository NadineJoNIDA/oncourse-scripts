records.each { Enrolment e ->
	csv << [
			...
			"studentCreatedOn"                  : e.student.createdOn?.format("yyyy-MM-dd'T'HH:mm:ssZ"),
			"studentModifiedOn"                 : e.student.modifiedOn?.format("yyyy-MM-dd'T'HH:mm:ssZ"),
			...
			"classCreatedOn"                    : e.courseClass.createdOn?.format("yyyy-MM-dd'T'HH:mm:ssZ"),
			"classModifiedOn"                   : e.courseClass.modifiedOn?.format("yyyy-MM-dd'T'HH:mm:ssZ"),
			"classDeliveryMode"                 : e.courseClass.deliveryMode?.displayName,
			"classStartDateTime"                : e.courseClass.startDateTime?.format("yyyy-MM-dd'T'HH:mm:ssZ", e.courseClass.timeZone),
			"classEndDateTime"                  : e.courseClass.endDateTime?.format("yyyy-MM-dd'T'HH:mm:ssZ", e.courseClass.timeZone),
			...
			"classReportableHours"              : e.courseClass.reportableHours,
			...
			"courseCreatedOn"                   : e.courseClass.course.createdOn?.format("yyyy-MM-dd'T'HH:mm:ssZ"),
			"courseModifiedOn"                  : e.courseClass.course.modifiedOn?.format("yyyy-MM-dd'T'HH:mm:ssZ"),
			...
			"courseReportableHours"             : e.courseClass.course.reportableHours,

/*(
importFile=Please select paymentIn CSV file...
)*/
...
reader.eachLine { line  ->
    ...
    SystemUser currentUser = SelectById.query(SystemUser, getSystemUsersByRole.getCurrentUserId())
            .selectOne(context)
    ...
    context.newObject(PaymentIn).with { PaymentIn paymentIn ->
        ...
        paymentIn.administrationCentre = currentUser.defaultAdministrationCentre
        paymentIn.amount = amount
        paymentIn.confirmationStatus = ConfirmationStatus.DO_NOT_SEND
        paymentIn.createdBy = currentUser
